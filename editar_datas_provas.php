...
// Simulação de informações de datas de provas
$datasProvas = [
...
$dataProva = ($index >= 0 && $index < count($datasProvas)) ? $datasProvas[$index] : null;
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $datasProvas[$index]["data"] = $newData;
    $datasProvas[$index]["descricao"] = $newDescricao;
...
<head>
    ...
    <title>Editar Data de Prova</title>
</head>
<body>
    <header>
        <h1>Editar Data de Prova</h1>
    </header>
    <div class="container">
        <div class="content">
            <form action="" method="POST">
                <label for="new_data">Nova Data:</label>
                <input type="date" id="new_data" name="new_data" value="<?php echo $dataProva['data']; ?>" required><br>
                
                <label for="new_descricao">Nova Descrição:</label>
                <input type="text" id="new_descricao" name="new_descricao" value="<?php echo $dataProva['descricao']; ?>" required><br>
